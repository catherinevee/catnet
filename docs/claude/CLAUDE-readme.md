...
5. **Features**
   ...
   - Use **[PASS]** checkmarks for completed features
   - Use **[WIP]** for features in development
...
### **[AVOID]** Formatting Anti-Patterns
...
project.doSomething(); // => "**[SUCCESS]** It works!"
```
